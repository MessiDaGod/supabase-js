    ...
    var e,
      ...
      i = {
        450: (e, t, s) => {
          s.r(t),
            s.d(t, {
              ...
              AuthPKCEGrantCodeExchangeError: () => x,
              ...
              isAuthApiError: () => T,
              isAuthError: () => k,
              isAuthRetryableFetchError: () => R,
              isAuthWeakPasswordError: () => L,
              lockInternals: () => V,
              navigatorLock: () => Q,
            })
          const r = '2.64.2',
          ...
          async function D(e) {
            var t
            if (!d(e)) throw new C(U(e), 0)
            if (N.includes(e.status)) throw new C(U(e), e.status)
            let s, r
            try {
              s = await e.json()
            } catch (e) {
            ...
            if (
              ...
              throw new I(U(s), e.status, s.weak_password.reasons)
            throw new S(U(s), e.status || 500, r)
          }
            ...
            const l = Object.keys(c).length ? '?' + new URLSearchParams(c).toString() : '',
              h = await (async function (e, t, s, r, i, n) {
                ...
                try {
                  ...
                  throw (console.error(e), new C(U(e), 0))
                }
                if ((a.ok || (await D(a)), null == r ? void 0 : r.noResolveJson)) return a
                try {
                  return await a.json()
                } catch (e) {
                  await D(e)
            ...
            async listUsers(e) {
              ...
              try {
                const c = { nextPage: null, lastPage: 0, total: 0 },
                  l = await F(this.fetch, 'GET', `${this.url}/admin/users`, {
                    headers: this.headers,
                    noResolveJson: !0,
                    query: {
                      page:
          ...
          async function Q(e, t, s) {
            V.debug && console.log('@supabase/gotrue-js: navigatorLock: acquire lock', e, t)
            ...
            return (
              ...
              await globalThis.navigator.locks.request(
                ...
                async (r) => {
                  ...
                  V.debug && console.log('@supabase/gotrue-js: navigatorLock: acquired', e, r.name)
                  try {
                    return await s()
                  } finally {
                    V.debug &&
          ...
          class se {
            constructor(e) {
              ...
              ;(this.memoryStorage = null),
                ...
                (this.instanceID = se.nextInstanceID),
                (se.nextInstanceID += 1),
                this.instanceID > 0 &&
                  a() &&
                  console.warn(
              ...
              const r = Object.assign(Object.assign({}, Z), e)
              if (
                ...
                (this.admin = new G({ url: r.url, headers: r.headers, fetch: r.fetch })),
                (this.url = r.url),
                ...
                this.persistSession
                  ? r.storage
                    ...
                    : l()
                    ? (this.storage = K)
                    : ((this.memoryStorage = {}), (this.storage = W(this.memoryStorage)))
                  : ((this.memoryStorage = {}), (this.storage = W(this.memoryStorage))),
            ...
            async _exchangeCodeForSession(e) {
              const t = await p(this.storage, `${this.storageKey}-code-verifier`),
                [s, r] = (null != t ? t : '').split('/'),
                { data: i, error: n } = await F(
                  this.fetch,
                  'POST',
                  `${this.url}/token?grant_type=pkce`,
                  { headers: this.headers, body: { auth_code: e, code_verifier: s }, xform: M }
                )
              return (
              ...
              try {
                ...
                if ('phone' in e) {
                  const { phone: t, options: s } = e,
                    { data: o, error: a } = await F(this.fetch, 'POST', `${this.url}/otp`, {
                      headers: this.headers,
                      body: {
                        phone: t,
            ...
            async verifyOtp(e) {
              ...
              try {
                ...
                const { data: n, error: o } = await F(this.fetch, 'POST', `${this.url}/verify`, {
                  headers: this.headers,
            ...
            async signInWithSSO(e) {
              ...
              try {
                ...
                return (
                  ...
                  await F(this.fetch, 'POST', `${this.url}/sso`, {
                    body: Object.assign(
                      Object.assign(
                        Object.assign(
                          Object.assign(
            ...
            async _reauthenticate() {
              try {
                return await this._useSession(async (e) => {
                  ...
                  if (s) throw s
                  if (!t) throw new j()
                  const { error: r } = await F(this.fetch, 'GET', `${this.url}/reauthenticate`, {
                    headers: this.headers,
                    jwt: t.access_token,
                  })
              ...
              try {
                ...
                if ('email' in e) {
                  const { email: s, type: r, options: i } = e,
                    { error: n } = await F(this.fetch, 'POST', t, {
                      headers: this.headers,
                      body: {
                        email: s,
                        type: r,
                ...
                if ('phone' in e) {
                  const { phone: s, type: r, options: i } = e,
                    { data: n, error: o } = await F(this.fetch, 'POST', t, {
                      headers: this.headers,
                      body: {
                        phone: s,
                        type: r,
            ...
            async _updateUser(e, t = {}) {
              try {
                return await this._useSession(async (s) => {
                  ...
                  const { data: c, error: l } = await F(this.fetch, 'PUT', `${this.url}/user`, {
                    headers: this.headers,
            ...
            async _getSessionFromURL(e) {
              try {
                ...
                if ('pkce' == this.flowType && !e) throw new x('Not a valid PKCE flow url.')
                const t = h(window.location.href)
                if (e) {
                  if (!t.code) throw new x('No code detected.')
            ...
            async linkIdentity(e) {
              ...
              try {
                const { data: s, error: r } = await this._useSession(async (t) => {
                  ...
                  return await F(this.fetch, 'GET', l, {
                    headers: this.headers,
                    jwt:
                      null !==
            ...
            async _autoRefreshTokenTick() {
              ...
              try {
                  ...
                  try {
                    ...
                    try {
                      return await this._useSession(async (t) => {
                        ...
                        const r = Math.floor((1e3 * s.expires_at - e) / ee)
                        this._debug(
                ...
                if (!(e.isAcquireTimeout || e instanceof Y)) throw e
            ...
            async _enroll(e) {
              try {
                return await this._useSession(async (t) => {
                  ...
                  const { data: o, error: a } = await F(this.fetch, 'POST', `${this.url}/factors`, {
                    body: {
              ...
              return this._acquireLock(-1, async () => {
                try {
                  return await this._useSession(async (t) => {
                    ...
                    return i
                      ? { data: null, error: i }
                      : await F(this.fetch, 'POST', `${this.url}/factors/${e.factorId}/challenge`, {
                          headers: this.headers,
                          jwt:
                            null === (s = null == r ? void 0 : r.session) || void 0 === s
                              ? void 0
        ...
        0: (e, t, s) => {
          ...
          class n {
            ...
            then(e, t) {
              ...
              let s = (0, this.fetch)(this.url.toString(), {
                ...
                return { error: n, data: o, count: a, status: c, statusText: l }
              })
              return (
          ...
          const l = { 'X-Client-Info': 'postgrest-js/1.15.2' }
          class h {
            constructor(e, { headers: t = {}, schema: s, fetch: r } = {}) {
              ;(this.url = e),
            ...
            schema(e) {
              return new h(this.url, { headers: this.headers, schema: e, fetch: this.fetch })
            }
          ...
          class P {
            constructor(e, t = { config: {} }, s) {
              ;(this.topic = e),
                ...
                (this.joinPush = new f(this, o.join, this.params, this.timeout)),
        ...
        752: (e, t, s) => {
          ...
          class _ {
            ...
            list(e, t, s) {
              return y(this, void 0, void 0, function* () {
                try {
                  const r = Object.assign(Object.assign(Object.assign({}, v), t), {
                    prefix: e || '',
                  })
                  return {
                    data: yield p(
            ...
            _initSupabaseAuthClient(
              ...
              return new u.SupabaseAuthClient({
                ...
                hasCustomAuthorizationHeader:
                  null !== (l = 'Authorization' in this.headers) && void 0 !== l && l,
              })
            }
    ...
    return (
      ...
      (() => {
        ...
        if (!e && t && (t.currentScript && (e = t.currentScript.src), !e)) {
          ...
          if (s.length) for (var r = s.length - 1; r > -1 && !e; ) e = s[r--].src
        }
